...
if (prep) {
  ...
  save(sgvc_pred, sgvc, file = "Bochukova_realigned/sgfc_pred.RData") 
} else {
  load("Bochukova_realigned/sgfc_pred.RData")
}
...
save(DexSeqExons.loc, file = "Bochukova_realigned/dexseq.RData") 
